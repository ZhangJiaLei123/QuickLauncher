...
import com.heneng.launcher.adapter.AppUninstallAdapter;
 ...
 * @since 2016.4.1
 */
public class AppUninstallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("android.intent.action.PACKAGE_ADDED")) {
                ...
                localAppBean.setImage(info.activityInfo.loadIcon(localPackageManager));
                localAppBean.setTitle(info.activityInfo.loadLabel(localPackageManager).toString());
