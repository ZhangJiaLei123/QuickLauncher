...
public class MediaModel implements Parcelable {
 ...
 //   private Drawable image;
    ...
    protected MediaModel(Parcel in) {
        ...
        imageUrl = new File(in.readString());
    ...
    public static List<MediaModel> getPhotoModels() {
        ...
        File urls[] = {
                new File("/storage/sdcard/Pictures/gray_src_1.jpg"),
                new File("/storage/sdcard/Pictures/gray_src_2.jpg"),
                new File("/storage/sdcard/Pictures/gray_src_3.jpg"),
                new File("/storage/sdcard/Pictures/gray_src_4.jpg"),
                new File("/storage/sdcard/Pictures/gray_src_5.jpg"),
                new File("/storage/sdcard/Pictures/gray_src_6.jpg"),
        };
    ...
    public static List<MediaModel> getVideoModels() {
        ...
        File urls[] = {
                new File("/storage/sdcard/Pictures/gray_src_7.jpg"),
                new File("/storage/sdcard/Pictures/gray_src_8.jpg"),
        };
