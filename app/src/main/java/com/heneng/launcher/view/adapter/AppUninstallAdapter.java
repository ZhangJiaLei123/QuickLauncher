...
public class AppUninstallAdapter extends BaseAdapter {
    ...
    private final List<AppInfoBean> appBeanList;
    private final Context context;

    public AppUninstallAdapter(Context context, List<AppInfoBean> appBeanList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AppInfoBean appBean = appBeanList.get(position);
        holder.icon.setBackgroundDrawable(appBean.getImage());
        holder.name.setText(appBean.getTitle());
        return convertView;
    }
